                        ...
                        <div class="row position-relative align-items-center pt-4">
                            <div class="col-lg-7 offset-lg-5">
                                <div class="title-heading studio-home bg-white shadow mt-5">
                                    <h1 class="heading mb-3">Present Your Work With <span class="text-primary">Taxvisor</span> </h1>
                                    <p class="para-desc text-muted">Invoice Project.</p>
                                    <div class="mt-4">
                                        <a href="/AddInvoice" class="btn btn-primary mt-2 mr-2"><i class="mdi mdi-phone"></i> Add Invoice</a>
                                        <a  href="/ViewInvoices" class="btn btn-outline-primary mt-2"><i class="mdi mdi-book-outline"></i>View Invoices </a>
                                    </div>
                                </div>
                            </div>
                        </div>
